/* Filtre par catégories sur les pages articles et articles-admin */
...
// Eléments à filtrer
const elements = document.querySelectorAll('.filter-list > div')
...
for (let buttonFiltre of buttonsFiltre) {
    buttonFiltre.addEventListener('click', function (ev) {
        ...
        // Ne montrer que les éléments filtrés
        for (elt of elements) {
